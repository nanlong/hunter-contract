...
contract Hunter2 is Ownable {
    ...
    function uniswapV2Call(
        ...
        for (uint256 i = 0; i < last; i++) {
            (amount0Out, amount1Out) = UniswapV2Library.getPiarAmountOut(
                callbackData.path[i],
                callbackData.fees[i],
        ...
        amountOut = UniswapV2Library.getPairAmountOut(
        ...
        require(amountOut > callbackData.amountIn, "4");
